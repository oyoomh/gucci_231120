...
function pcCollectionSwiper__init (){
	const swiper1 = new Swiper(".pc-swiper .swipeslide__slide", {
	slidesPerView: "auto",
	loop: true,
	spaceBetween: 150,
	centeredSlides: true,
	...
	navigation: {
			nextEl: '.swipeslide-btn .arrow__btn-next',
			prevEl: '.swipeslide-btn .arrow__btn-prev',
		},
});
...
function mobileCollectionSwiper__init() {
	const swiper2 = new Swiper(".mobile-swiper .slide-list__swiper", {
	slidesPerView: "auto",
	loop: true,
	spaceBetween: 20,
	centeredSlides: true,
